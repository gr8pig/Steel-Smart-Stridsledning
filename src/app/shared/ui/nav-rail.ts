...
export class NavRail {
  ...
  navItems = [
    ...
    { path: '/reference/c2-resilience-lab', icon: 'sensors',  label: 'C2 Resilience Lab',      flag: null },
    ...
    { path: '/reference',       icon: 'menu_book',             label: 'Reference Atlas',         flag: null },
    ...
    { path: '/reference/counterfactual-lab', icon: 'compare_arrows', label: 'Counterfactual Lab', flag: null },
