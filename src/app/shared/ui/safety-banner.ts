...
@Component({
  ...
  template: `
    @if (capabilityStore.isPublic()) {
      <div class="absolute top-0 left-0 right-0 z-[100] h-6 bg-boreal-amber/90 backdrop-blur-md flex items-center justify-center border-b border-boreal-amber/40 shadow-lg">
