...
const CORE_PLATFORM_NODES: TechNode[] = [
  ...
  node({
    ...
    where: '`/knowledge-graph`, `Steel-Smart-Stridsledning/src/app/features/governance/knowledge-graph.component.ts`, `Steel-Smart-Stridsledning/src/app/core/state/knowledge-graph.store.ts`, `Steel-Smart-Stridsledning/src/app/core/models/knowledge-graph.types.ts`.',
