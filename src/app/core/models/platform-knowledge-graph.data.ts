...
const CORE_PLATFORM_NODES: TechNode[] = [
  ...
  node({
    ...
    where: '`boreal-info-arch/src/app/features/governance/governance-overview.component/knowledge-graph.component/governance/knowledge-graph.component.ts` and `boreal-info-arch/00-index.md`.',
    who: 'Platform designers and anyone comparing scaffold intent to ship state.',
    sourcePath: 'boreal-info-arch/src/app/features/governance/governance-overview.component/knowledge-graph.component/governance/knowledge-graph.component.ts',
  ...
  node({
    ...
    where: '`/governance/knowledge-graph`, `Steel-Smart-Stridsledning/src/app/features/governance/governance-overview.component/knowledge-graph.component.ts`, `Steel-Smart-Stridsledning/src/app/core/state/knowledge-graph.store.ts`, `Steel-Smart-Stridsledning/src/app/core/models/knowledge-graph.types.ts`.',
    who: 'Analysts and users exploring the platform map.',
    route: '/governance/knowledge-graph',
    sourcePath: 'Steel-Smart-Stridsledning/src/app/features/governance/governance-overview.component/knowledge-graph.component.ts',
...
const OPERATIONS_NODES: TechNode[] = [
  ...
  node({
    ...
    where: '`ops/mission-overview.component.ts`, `ops/tactical-console.component.ts`, `c2/c2-orchestrator.component.ts`, `lab/readiness-console.component.ts`, `ops/logistics-console.component.ts`, `ops/field-console.component.ts`.',
  ...
  node({
    ...
    where: '`ops/threat-inspector.component.ts`, `lab/robustness-lab.component.ts`, `lab/counterfactual-lab.component.ts`, `lab/c2-resilience-lab.component.ts`, `lab/drawing-board.component.ts`, `ops/demo-director.component.ts`.',
  ...
  node({
    ...
    where: '`governance/governance-overview.component.ts`, `c2/authority-dashboard.component.ts`, `audit-logger.ts`.',
    who: 'Governance reviewer and command authority.',
    sourcePath: 'Steel-Smart-Stridsledning/src/app/features/governance/governance-overview.component/governance-overview.component.ts',
...
const ANALYTICAL_AND_ROUTE_NODES: TechNode[] = [
  node({
    ...
    where: '`features/ops/tactical-console.component.ts`, `features/ops/threat-inspector.component.ts`, `core/state/tactical.store.ts`.',
  ...
  node({
    ...
    where: '`features/c2/c2-orchestrator.component.ts`, `c2/components/commander-header-panel.ts`, `c2/components/commander-frontier-panel.ts`, `c2/components/commander-outcome-panel.ts`, `c2/components/commander-policy-panel.ts`.',
  ...
  node({
    ...
    where: '`features/ops/logistics-console.component.ts`, `core/state/logistics.store.ts`, `shared/domain/logistics-ontology.ts`.',
  ...
  node({
    ...
    where: '`features/ops/field-console.component.ts`.',
    who: 'Field operator.',
  ...
  node({
    ...
    where: '`features/ops/threat-inspector.component.ts`, `core/services/intent-estimator.service.ts`.',
  ...
  node({
    ...
    where: '`features/lab/c2-resilience-lab.component.ts`, `core/state/decision-fabric.store.ts`, `core/sim/command-friction-engine.ts`.',
    who: 'Commander, governance reviewer, and analyst.',
    sourcePath: 'Steel-Smart-Stridsledning/src/app/features/lab/c2-resilience-lab.component.ts',
  ...
  node({
    ...
    where: '`features/ops/demo-director.component.ts`.',
    who: 'Demo operator and presenter.',
    sourcePath: 'Steel-Smart-Stridsledning/src/app/features/ops/demo-director.component.ts',
