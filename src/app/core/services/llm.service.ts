...
import { SteelApiService, LabRunResult, LogisticsContext } from './steel-api.service';

export type { LogisticsContext } from './steel-api.service';
 ...
 * This service routes all rationale requests through SteelApiService → server.ts.
