  ...
  },
  {
    ...
    branches: [
      ...
      },
      {
        ...
        counterfactual:
          "Under higher threat this branch becomes non-viable instantly.",
      },
    ],
  },
];
...
const SLIDE_PREVIEW_COPY: SlidePreviewCopy[] = [
  {
    ...
    detail:
      "Målet, användaren och den verksamhetskritiska frågan i en enda vy.",
    bullets: [
      "Vem som leder beslutet",
      "Varför nästa våg avgör",
      "Vad Steel försöker bevisa",
    ],
  },
  {
    lead: "Operatörens flöde",
    detail:
      "En minutlång scenariodemo där kartan växlar mellan angrepp, interception och supply lines, och recommendation-fliken ändrar vilket förlopp som spelas.",
    bullets: [
      "Klicka spår och objekt",
      "Växla rekommendationer",
      "Se när ett beslut måste tas",
    ],
  },
  {
    lead: "Policy-driven COA",
    detail:
      "Tre alternativ jämförs enkelt: snabbast effekt, balanserad reserve och djup uthållighet.",
    bullets: [
      "Vad varje COA betyder",
      "Hur valet görs",
      "Varför BAL ofta är rätt",
    ],
  },
  {
    lead: "Kontrafaktisk validering",
    detail:
      "Beslutet stressas med decision trees, ML-inferens och Monte Carlo innan det får låsas.",
    bullets: [
      "Vad händer om antagandet ändras",
      "Vilken gren är skör",
      "När robustheten faller",
    ],
  },
  {
    lead: "Delad theatre state",
    detail:
      "Samma state måste kunna driva policy, readiness, logistics, governance och labs utan dubbeltydigheter.",
    bullets: [
      "Varför en källa behövs",
      "Vad ontologi löser",
      "Hur samma data återanvänds",
    ],
  },
  {
    lead: "Ontologi i praktiken",
    detail:
      "Fem domäner beskriver samma operativa verklighet med olika ansvar, inte fem separata system.",
    bullets: [
      "Beslutsstöd",
      "Lägesbild",
      "Uthållighet",
  ...
  },
  {
    ...
    detail:
      "Grafen binder samman ytorna så att man kan följa ett system från policy till demo och tillbaka, nod för nod.",
    bullets: [
      "Hur nätverket spelas igenom",
      "Vilka ytor som blir möjliga",
      "Varför unification är nyckeln",
    ],
  },
  {
    lead: "Svar på frågan",
    detail:
      "Hackathonet bad inte om ett helt system, men ontologin visar varför ett smart C2-system går att bygga: causal intent, konkreta förslag, lägre kognitiv belastning och snabb closed-loop evaluation mot verklig sensordata.",
    bullets: [
      "Varför inte hela systemet",
      "Vad ontologin möjliggör",
      "Hur systemet lär sig av verklig data",
    ],
  },
];
...
const SLIDES: SlideConfig[] = [
  {
    ...
    title: "STEEL",
    subtitle:
      "Ett ledningssystem för framtidens luftförsvar måste vinna nu och samtidigt bevara förmåga för nästa våg",
  },
  {
    id: "map",
  ...
  },
  {
    ...
    subtitle:
      "Enkel skillnad mellan snabb effekt nu, balanserad reserve och djup uthållighet",
  },
  {
    id: "board",
    ...
    subtitle:
      "Beslutet testas med decision trees, ML-inferens och Monte Carlo innan det får låsas",
  },
  {
    id: "ml",
    ...
    subtitle:
      "Samma state måste bära policy, readiness, logistik, governance och labs för att allt ska kunna hänga ihop",
  },
  {
    id: "governance",
    eyebrow: "Ontologi",
    ...
    subtitle:
      "Ontologin behövs för att samma data ska betyda samma sak i alla ytor",
  },
  {
    id: "kg",
    eyebrow: "Unification",
    ...
    subtitle:
      "Knowledge grafen visar hur samma state öppnar fler ytor utan att skapa nya sanningar",
  },
  {
    id: "summary",
    eyebrow: "Slutsats",
    ...
    subtitle:
      "Hackathonet bad inte om ett helt system, utan om den del som gör smart stridsledning möjlig: ontologin som ger causal intent, tydliga förslag och snabb utvärdering mot verklig sensordata",
  },
];
...
interface MapTrack {
  ...
  tx: number;
  ty: number;
  type: "missile" | "ship" | "air";
}
interface AnimatedTrack extends MapTrack {
  cx: number;
  cy: number;
}
interface DemoCue {
...
interface TrackDecisionSupport {
  label: string;
  value: string;
  detail: string;
}
...
const SCENARIO_STORIES: ScenarioStory[] = [
  {
    ...
    detail:
      "Operatören måste skilja på den spårbild som ska stoppas nu och det som ska lämnas kvar för att skydda nästa våg.",
  ...
  },
  {
    ...
    detail:
      "Systemet måste välja mellan snabb avfyring, bevarad beredskap och fortsatt kontroll av inbound-tracket.",
  ...
  },
  {
    ...
    detail:
      "Data om last, corridor, resume-rate, runway pressure och drönarsvärm gör att ett beslut måste tas tidigt, inte efter att linjen brutits.",
    decision:
      "Skydda supply line nu, eller bevara stridsförmåga för ett bättre läge senare?",
  },
];
...
const SCENARIO_RECOMMENDATIONS: ScenarioRecommendation[] = [
  ...
  },
  {
    ...
    summary:
      "Prioritera interceptor-fönstret innan salvo splittras över flera mål.",
    scenarioIndex: 1,
    trackId: "M2",
    decision: "Fire before the window closes",
    impact:
      "Simuleringen växlar till intercept-fas och visar kostnaden för att vänta.",
  },
  {
    id: "rec-supply",
    ...
    impact:
      "Beslutspunkten flyttar framåt när logistikdata ingår i beräkningen.",
  },
];
...
const KG_PATH_NODES: KnowledgePathNode[] = [
  {
    ...
    detail:
      "All data samlas i en gemensam state så att policy, readiness, logistics och governance ser samma läge.",
  ...
  },
  {
    ...
    detail:
      "Beslutet score:as mot effekt nu, uthållighet och commander posture innan ett COA får bli rekommendation.",
  ...
  },
  {
    ...
    detail:
      "Inference stressas mot alternativa träd, osäkerhet och friktion så att beslutet går att lita på före commit.",
  ...
  },
  {
    ...
    detail:
      "Audit-logg, policy trace och auktoritet följer exakt samma beslutskedja som operatören ser på skärmen.",
  ...
  },
  {
    ...
    detail:
      "Frontend får samma domänmodell som backend, så att ett kommando i grafen blir begripligt i fältet.",
...
const COA_GUIDE = [
  ...
  },
  {
    ...
    tradeoff:
      "Det är den säkraste mittpunkten när commander posture är osäker.",
  },
  {
    id: "guide-dst",
    title: "COA-DST",
    ...
    tradeoff:
      "Du accepterar lägre omedelbar effekt för att säkra lång uthållighet.",
  },
  {
    id: "guide-flow",
    ...
    tradeoff:
      "Operatören får ett tydligt svar plus motivering, inte bara ett tal.",
  },
] as const;
...
const TERRAIN = {
  north:
    "0,0 1667,0 1667,283 1533,313 1433,290 1333,283 1237,342 1130,317 1027,297 927,353 813,323 713,313 610,367 503,320 393,333 297,383 197,340 90,353 0,380",
  south:
    "0,1300 1667,1300 1667,1067 1580,1027 1470,1047 1363,1070 1260,1013 1147,1037 1040,1067 933,1010 820,1043 713,1077 603,1020 490,1037 387,1080 280,1030 163,1050 50,1080 0,1063",
  islandWest:
    "592,447 630,427 683,430 707,463 727,493 710,537 677,547 643,557 603,530 590,497",
  islandEast:
    "1130,357 1153,340 1183,347 1193,373 1203,397 1187,423 1160,427 1133,430 1113,407 1113,380",
  southFwd:
    "1363,713 1403,693 1450,703 1460,737 1470,767 1443,800 1410,800 1377,800 1350,773 1353,743",
};
      ...
      <header class="showcase-header">
        <div class="flex items-center gap-3">
          ...
          <div class="flex flex-col">
            <span
              class="text-[9px] font-black uppercase tracking-[0.3em] text-[var(--s-muted)]"
              >Saab Smart Stridsledning</span
            >
            <span
              class="text-[11px] font-bold uppercase tracking-[0.15em] text-[var(--s-text)]"
              >Boreal Decision Twin</span
            >
          </div>
        </div>
        <div class="flex items-center gap-4">
          <span
            class="text-[9px] font-mono text-[var(--s-muted)] uppercase tracking-widest"
            >Hackathon Demo · 2026</span
          >
      ...
      <main class="showcase-main">
          ...
          <div class="slide slide-welcome animate-in">
            <div class="slide-welcome-inner">
              ...
              <div class="welcome-chips">
                <div class="w-chip">
                  <span class="w-chip-dot blue"></span>Sensorfusion måste bli
                  RAP, inte bara en vy
                </div>
                <div class="w-chip">
                  <span class="w-chip-dot green"></span>Resursallokering måste
                  ta nästa våg i beräkning
                </div>
                <div class="w-chip">
                  <span class="w-chip-dot purple"></span>Uthållighet måste
                  skyddas när hoten eskalerar
                </div>
              </div>
              ...
              <div class="welcome-stack">
                <div class="stack-row">
                  ...
                  <span class="stack-value"
                    >Tactical Operator, Air Defense Commander, Base Readiness
                    Officer, Intelligence & Analysis Officer</span
                  >
                </div>
                <div class="stack-row">
                  <span class="stack-label">Problem</span>
                  <span class="stack-value"
                    >Mättnadsattack, begränsade verkansresurser, bevara framtida
                    handlingsfrihet</span
                  >
                </div>
                <div class="stack-row">
                  <span class="stack-label">Metod</span>
                  <span class="stack-value"
                    >Multi-objective Pareto-optimering, Digital Twins för
                    readiness/logistik, Robustness Lab</span
                  >
                </div>
                <div class="stack-row">
                  <span class="stack-label">Mål</span>
                  <span class="stack-value"
                    >Gå från "map-centric" nouns till "decision-centric"
                    verbs</span
                  >
                </div>
              </div>
            ...
            <div class="slide-split">
              <div class="slide-left-panel">
                ...
                <div class="scenario-story">
                  <div class="scenario-story-kicker">
                    {{ currentScenarioStory().lead }}
                  </div>
                  <div class="scenario-story-detail">
                    {{ currentScenarioStory().detail }}
                  </div>
                  <div class="scenario-story-decision">
                    Beslutspunkt: {{ currentScenarioStory().decision }}
                  </div>
                </div>

                <div class="recommendation-panel">
                  <div class="recommendation-panel-head">
                    <span class="recommendation-panel-kicker"
                      >Rekommendation</span
                    >
                    <span class="recommendation-panel-meta">{{
                      currentRecommendation().title
                    }}</span>
                  </div>
                  <div class="recommendation-panel-current">
                    <div class="recommendation-panel-decision">
                      {{ currentRecommendation().decision }}
                    </div>
                    <div class="recommendation-panel-impact">
                ...
                <div class="scenario-tabs">
                  @for (s of scenarioLabels; track $index) {
                    <button
                      class="s-tab"
                      [class.active]="mapScenario() === $index"
                ...
                <div class="recommendation-panel">
                  ...
                  <div class="recommendation-tabs">
                    @for (
                      rec of scenarioRecommendations;
                      track rec.id;
                      let i = $index
                    ) {
                      <button
                        class="recommendation-card"
                        [class.recommendation-card-active]="
                          recommendationIndex() === i
                        "
                        (click)="selectRecommendation(i)"
                      >
                        <div class="recommendation-card-top">
                          <span class="recommendation-card-index"
                            >0{{ i + 1 }}</span
                          >
                          <span class="recommendation-card-flag">{{
                            rec.scenarioIndex === 2
                              ? "Logistics"
                              : rec.scenarioIndex === 1
                                ? "Intercept"
                ...
                <div class="map-legend">
                  <div class="legend-row">
                    <span class="legend-dot blue"></span> Egna styrkor och egna
                    baser
                  </div>
                  <div class="legend-row">
                    <span class="legend-dot red"></span> Hotsignatur och
                    inkommande tryck
                  </div>
                  <div class="legend-row">
                    <span class="legend-dot amber"></span> Sensor- och
                    intressezoner
                  </div>
                  <div class="legend-row">
                    <span class="legend-dot white"></span> Lägesbilden som ska
                    bli RAP
                  </div>
                </div>
                ...
                <div class="map-stats">
                  <div class="stat">
                    <span class="stat-v">{{ animatedTracks().length }}</span
                    ><span class="stat-l">Spår i den aktuella vågen</span>
                  </div>
                  <div class="stat">
                    <span
                      class="stat-v"
                      [class.stat-g]="!intercepting()"
                      [class.stat-r]="intercepting()"
                      >{{ intercepting() ? "HOLD" : "0.81" }}</span
                    >
                    <span class="stat-l">{{
                      intercepting() ? "Skyddad beredskap" : "Beslutssäkerhet"
                    }}</span>
                  </div>
                  <div class="stat">
                    <span class="stat-v stat-a">127ms</span
                    ><span class="stat-l">Svarstid till operatören</span>
                  </div>
                </div>
                <div class="map-phase-bar">
                  <div
                    class="map-phase-label"
                    [class.phase-intercept]="intercepting()"
                  >
                  ...
                  <div class="phase-bar-track">
                    <div
                      ...
                      [class.phase-fill-intercept]="intercepting()"
                    ></div>
                  </div>
                </div>
                  ...
                  <div class="track-decision-card">
                    <div class="track-decision-head">
                      <div>
                        ...
                        <div class="track-decision-title">
                          {{ selectedTrack.id }} ·
                          {{ selectedTrack.type.toUpperCase() }}
                        </div>
                      </div>
                      <div class="track-decision-badge">
                        {{
                          mapScenario() === 2
                            ? "Supply"
                            : selectedTrack.type === "missile"
                              ? "Threat"
                              : "Track"
                        }}
                      </div>
                    </div>
                    <div class="track-decision-summary">
                      {{ trackSummary(selectedTrack) }}
                    </div>
                    <div class="decision-support-grid">
                      @for (
                        point of trackDecisionSupport(selectedTrack);
                        track point.label
                      ) {
                        <div class="decision-support-card">
                          <div class="decision-support-label">
                            {{ point.label }}
                          </div>
                          <div class="decision-support-value">
                            {{ point.value }}
                          </div>
                          <div class="decision-support-detail">
                            {{ point.detail }}
                          </div>
                        </div>
                      }
                    </div>
                    <div class="track-decision-foot">
                      {{ scenarioLabels[mapScenario()] }}
                    </div>
                  </div>
                ...
                <div class="timeline-control">
                  <div class="timeline-top">
                    ...
                    >
                      <span class="s-tab-num">{{
                        trackPlaying() ? "II" : "▶"
                      }}</span>
                      <span class="s-tab-label">{{
                        trackPlaying() ? "Pausa demo" : "Spela demo"
                      }}</span>
                    </button>
                    <span class="timeline-label"
                      >Demo {{ trackProgress() * 100 | number: "1.0-0" }}%</span
                    >
                  </div>
                  <input
              ...
              <div class="map-container">
                ...
                >
                  ...
                  <!-- North terrain -->
                  <polygon
                    [attr.points]="terrain.north"
                    fill="rgba(92,167,255,0.06)"
                    stroke="rgba(92,167,255,0.18)"
                    stroke-width="1.5"
                  />
                  <!-- South terrain -->
                  <polygon
                    [attr.points]="terrain.south"
                  ...
                  <!-- Islands -->
                  <polygon
                    [attr.points]="terrain.islandWest"
                    fill="rgba(92,167,255,0.08)"
                    stroke="rgba(92,167,255,0.25)"
                    stroke-width="1"
                  />
                  <polygon
                    [attr.points]="terrain.islandEast"
                    fill="rgba(92,167,255,0.08)"
                    stroke="rgba(92,167,255,0.25)"
                    stroke-width="1"
                  />
                  <polygon
                    [attr.points]="terrain.southFwd"
                  ...
                  @if (mapScenario() === 2) {
                    <g opacity="0.95">
                      <path
                        d="M 240 1140 C 330 1000, 370 860, 430 720 C 480 600, 520 510, 590 430"
                        fill="none"
                      ...
                      />
                      <path
                        d="M 430 1120 C 500 980, 560 830, 640 690 C 700 580, 740 500, 780 400"
                        fill="none"
                      ...
                      />
                      <path
                        d="M 860 1140 C 910 990, 950 850, 980 710 C 1010 570, 1040 500, 1080 430"
                        fill="none"
                  ...
                  @for (track of animatedTracks(); track track.id) {
                    <g
                      ...
                      (click)="selectScenarioTrack(track.id)"
                    >
                      ...
                      <g
                        [attr.transform]="
                          'translate(' + track.tx + ',' + track.ty + ')'
                        "
                      >
                        <circle
                          r="6"
                          fill="none"
                          stroke="rgba(92,167,255,0.4)"
                          stroke-width="1"
                      ...
                      @if (intercepting()) {
                        ...
                        >
                          <circle
                            r="7"
                            fill="rgba(92,167,255,0.95)"
                            class="intercept-core"
                          />
                          <circle
                            r="18"
                            fill="none"
                          ...
                          <circle
                            ...
                            stroke="#7ce0be"
                            stroke-width="1"
                            class="intercept-ring intercept-ring-2"
                          />
                        </g>
                      }
                      ...
                      <g
                        [attr.transform]="
                          'translate(' + track.cx + ',' + track.cy + ')'
                        "
                        filter="url(#sc-glow-r)"
        ...
        @if (currentSlide() === 2) {
          <div class="slide slide-ai animate-in">
            ...
            <div class="data-strip">
              <div class="data-pill">
                <span class="data-pill-num">3</span
                ><span class="data-pill-label">COA-grenar</span
                ><span class="data-pill-text">MAX, BAL, DST</span>
              </div>
              <div class="data-pill">
                <span class="data-pill-num">4</span
                ><span class="data-pill-label">Policy inputs</span
                ><span class="data-pill-text"
                  >posture, reserve, threat, wave 2</span
                >
              </div>
              <div class="data-pill">
                <span class="data-pill-num">9</span
                ><span class="data-pill-label">Scorefält</span
                ><span class="data-pill-text">3 metrics per alternativ</span>
              </div>
              <div class="data-pill">
                <span class="data-pill-num">1</span
                ><span class="data-pill-label">Rekommendation</span
                ><span class="data-pill-text"
                  >balanserat val med motivering</span
                >
              </div>
            </div>
            ...
            <div class="coa-primer-grid">
              @for (item of coaGuide; track item.id) {
                <div
                  class="coa-primer-card"
                  [class.coa-primer-active]="selectedCoaId() === item.title"
                >
            ...
            <div class="intent-card">
              <div class="intent-card-head">
                ...
                <div class="intent-card-meta">
                  1 track · 5 sannolikhetsklasser
                </div>
              </div>
              <div class="intent-card-grid">
                <div class="intent-card-item">
                  <span>probe</span><strong>0.08</strong>
                </div>
                <div class="intent-card-item">
                  <span>feint</span><strong>0.18</strong>
                </div>
                <div class="intent-card-item">
                  <span>strike</span><strong>0.52</strong>
                </div>
                <div class="intent-card-item">
                  <span>saturation</span><strong>0.17</strong>
                </div>
                <div class="intent-card-item">
                  <span>decoy</span><strong>0.05</strong>
                </div>
              </div>
            </div>
            ...
            <div class="ai-grid">
              ...
              <div class="ai-pareto-card">
                <div class="card-label">
                  Pareto-front · Beredskap vs. Bekämpningseffekt
                </div>
                <svg viewBox="0 0 320 220" class="pareto-svg">
                  ...
                  <!-- Pareto curve -->
                  <path
                    d="M 258,30 Q 160,80 80,155"
                    stroke="rgba(92,167,255,0.3)"
                    stroke-width="1.5"
                    fill="none"
                    stroke-dasharray="4,3"
                  />
                  ...
                  @for (coa of coas; track coa.id) {
                    ...
                    >
                      <circle
                        [attr.r]="selectedCoaId() === coa.id ? 9 : 6"
                        [attr.fill]="coa.color"
                        [attr.fill-opacity]="
                          selectedCoaId() === coa.id ? 0.9 : 0.5
                        "
                        [attr.stroke]="coa.color"
                        stroke-width="1.5"
                      />
              ...
              <div class="coa-list">
                @for (coa of coas; track coa.id) {
                  <div
                    class="coa-card"
                    [class.coa-selected]="selectedCoaId() === coa.id"
                    (click)="selectedCoaId.set(coa.id)"
                    tabindex="0"
                    (keydown.enter)="selectedCoaId.set(coa.id)"
                    (keydown.space)="selectedCoaId.set(coa.id)"
                  >
                    <div class="coa-top">
                      <span class="coa-id" [style.color]="coa.color">{{
                        coa.id
                      }}</span>
                      @if (selectedCoaId() === coa.id) {
                    ...
                    <div class="coa-bars">
                      ...
                      <div class="coa-bar-row">
                        ...
                        <div class="coa-bar-track">
                          <div
                            class="coa-bar-fill"
                            [style.width]="coa.readiness + '%'"
                            style="background:rgba(124,224,190,0.7)"
                          ></div>
                        </div>
                      ...
                      <div class="coa-bar-row">
                        ...
                        <div class="coa-bar-track">
                          <div
                            class="coa-bar-fill"
                            [style.width]="coa.robustness * 100 + '%'"
                            style="background:rgba(155,140,255,0.7)"
                          ></div>
                        </div>
              ...
              <div class="ai-rationale">
                ...
                <p class="rationale-text">
                  COA-MAX ger mest effekt nu, COA-BAL ger bäst balans och
                  COA-DST skyddar mest uthållighet. Steel väger fyra inputs och
                  nio scorevärden per beslut: commander posture, reserve floor,
                  hottryck och wave 2-beredskap.
                  <br /><br />
                  <span class="font-mono text-[9px] text-amber-500/80"
                    >Score(c) = λs·f_safety(c) - λu·f_sustain(c) +
                    λr·f_resilience(c)</span
                  >
                  <br />
                  <span class="font-mono text-[9px] text-sky-500/80"
                    >Asymmetry Ratio (AR) = RedNeutralized / BlueCost</span
                  >
                </p>
            ...
            <div class="slide-split">
              <div class="slide-left-panel">
                ...
                <div class="validation-explain">
                  <div class="validation-explain-kicker">
                    Vad som utvärderas
                  </div>
                  <div class="validation-explain-body">
                    {{ currentValidationTree().premise }}
                  </div>
                  <div class="validation-explain-meta">
                    {{ currentValidationTree().modelHint }}
                  </div>
                  <div class="validation-explain-note">
                    {{ currentValidationTree().collapseHint }}
                  </div>
                </div>
                ...
                <div class="validation-tree-strip">
                  @for (
                    tree of validationTrees;
                    track tree.id;
                    let i = $index
                  ) {
                    <button
                      class="validation-tree-card"
                      type="button"
                      [class.validation-tree-card-active]="
                        validationTreeIndex() === i
                      "
                      (click)="selectValidationTree(i)"
                    >
                      <div class="validation-tree-card-title">
                        {{ tree.title }}
                      </div>
                      <div class="validation-tree-card-premise">
                        {{ tree.premise }}
                      </div>
                      <div class="validation-tree-card-meta">
                        {{ tree.branches.length }} inferensgrenar
                      </div>
                    </button>
                  }
                </div>
                ...
                <div class="data-strip data-strip-tight">
                  <div class="data-pill">
                    <span class="data-pill-num">3</span
                    ><span class="data-pill-label">Trees</span
                    ><span class="data-pill-text"
                      >intercept, balance, corridor</span
                    >
                  </div>
                  <div class="data-pill">
                    <span class="data-pill-num">4</span
                    ><span class="data-pill-label">Stages</span
                    ><span class="data-pill-text"
                      >tree, ML, Monte Carlo, lab</span
                    >
                  </div>
                  <div class="data-pill">
                    <span class="data-pill-num">9</span
                    ><span class="data-pill-label">Branches</span
                    ><span class="data-pill-text">scored and traced live</span>
                  </div>
                  <div class="data-pill">
                    <span class="data-pill-num">1</span
                    ><span class="data-pill-label">Horizon</span
                    ><span class="data-pill-text"
                      >collapse threshold per tree</span
                    >
                  </div>
                </div>
                ...
                <div class="board-features">
                  @for (
                    step of validationSteps;
                    track step.id;
                    let i = $index
                  ) {
                    <div
                      class="board-feat"
                      [class.board-feat-active]="validationFocusIndex() === i"
                      (click)="validationFocusIndex.set(i)"
                      tabindex="0"
                      (keydown.enter)="validationFocusIndex.set(i)"
                      (keydown.space)="validationFocusIndex.set(i)"
                    >
                      <div class="feat-icon">{{ step.tag }}</div>
                      <div class="feat-text">
                        <div class="feat-title">{{ step.title }}</div>
              ...
              <div class="board-demo-container">
                <div class="board-demo-label">
                  ROBUSTNESS LAB —
                  {{
                    validationSteps[validationFocusIndex()].title.toUpperCase()
                  }}
                  · {{ currentValidationTree().title.toUpperCase() }}
                </div>
                <div class="board-demo-stage">
                  <div class="board-demo-stage-head">
                    <div class="board-demo-stage-title">
                      {{ currentValidationTree().premise }}
                    </div>
                    <div class="board-demo-stage-sub">
                      {{ currentValidationTree().modelHint }}
                    </div>
                  </div>
                  <svg
                    viewBox="0 0 760 420"
                    preserveAspectRatio="xMidYMid slice"
                    class="board-svg validation-svg"
                  >
                    <defs>
                      <filter id="tree-glow">
                    ...
                    <rect
                      ...
                      height="418"
                      rx="12"
                      fill="rgba(3,7,12,0.75)"
                      stroke="rgba(148,189,255,0.08)"
                    />
                    <text
                      x="32"
                      y="36"
                    ...
                    @for (
                      branch of currentValidationTree().branches;
                      track branch.label;
                      let i = $index
                    ) {
                      @let y = 90 + i * 110;
                      <g>
                        ...
                        <line
                          ...
                          [attr.y2]="y"
                          [attr.stroke]="
                            activeValidationBranchIndex() === i
                              ? 'rgba(124,224,190,0.9)'
                              : 'rgba(148,189,255,0.18)'
                          "
                          stroke-width="1.2"
                          stroke-dasharray="6,4"
                        />
                        <circle
                          ...
                          [attr.cy]="y"
                          [attr.r]="
                            activeValidationBranchIndex() === i ? 20 : 16
                          "
                          [attr.fill]="
                            activeValidationBranchIndex() === i
                              ? 'rgba(124,224,190,0.16)'
                              : 'rgba(92,167,255,0.08)'
                          "
                          [attr.stroke]="
                            activeValidationBranchIndex() === i
                              ? '#7ce0be'
                        ...
                        <circle
                          ...
                          [attr.cy]="y"
                          [attr.r]="
                            activeValidationBranchIndex() === i ? 24 : 19
                          "
                          fill="rgba(255,255,255,0.03)"
                          [attr.stroke]="
                            activeValidationBranchIndex() === i
                              ? '#7ce0be'
                              : 'rgba(156,176,199,0.22)'
                          "
                          stroke-width="1.2"
                        />
                        <text
                    ...
                    <g opacity="0.95">
                      ...
                      <text
                        ...
                        font-family="monospace"
                      >
                        which assumption flips the tree.
                      </text>
                      <text
                        x="536"
                        y="146"
                        ...
                        font-family="monospace"
                      >
                        Collapse: {{ currentValidationTree().collapseHint }}
                      </text>
                    </g>
                    <g>
                      <rect
                      ...
                      @for (
                        ...
                        <text
                          ...
                          [attr.y]="258 + j * 48"
                          font-size="9"
                          fill="rgba(156,176,199,0.72)"
                          font-family="monospace"
                        >
                          p {{ branch.probability }} · score {{ branch.score }}
                        </text>
                      }
                    </g>
                  </svg>
                ...
                <div class="validation-inference-grid">
                  @for (
                    ...
                    <button
                      class="validation-inference-card"
                      type="button"
                      [class.validation-inference-card-active]="
                        activeValidationBranchIndex() === i
                      "
                    >
                      <div class="validation-inference-top">
                        <span class="validation-inference-label">{{
                          branch.label
                        }}</span>
                        <span class="validation-inference-score">{{
                          branch.score
                        }}</span>
                      </div>
                      <div class="validation-inference-line">
        ...
        @if (currentSlide() === 4) {
          <div class="slide slide-ml animate-in">
            ...
            <div class="state-explain">
              ...
              <div class="state-explain-body">
                Utan ett gemensamt theatre state får policy, readiness,
                logistics och governance egna versioner av sanningen. Med en
                gemensam modell kan alla ytor läsa samma sak och fatta beslut på
                samma grund.
              </div>
            </div>
            ...
            <div class="data-strip data-strip-tight">
              <div class="data-pill">
                <span class="data-pill-num">5</span
                ><span class="data-pill-label">Domäner</span
                ><span class="data-pill-text"
                  >policy, readiness, logistics, governance, labs</span
                >
              </div>
              <div class="data-pill">
                <span class="data-pill-num">3</span
                ><span class="data-pill-label">Ytor</span
                ><span class="data-pill-text"
                  >API, state backbone, domain models</span
                >
              </div>
              <div class="data-pill">
                <span class="data-pill-num">1</span
                ><span class="data-pill-label">Sanning</span
                ><span class="data-pill-text">samma semantik överallt</span>
              </div>
              <div class="data-pill">
                <span class="data-pill-num">0</span
                ><span class="data-pill-label">Drift</span
                ><span class="data-pill-text">inga kopierade snapshots</span>
              </div>
            </div>
            ...
            <div class="ml-grid">
              ...
              <div
                class="ml-card ml-card-primary"
                [class.ml-card-focus]="modelFocusIndex() === 0"
                (click)="modelFocusIndex.set(0)"
                tabindex="0"
                (keydown.enter)="modelFocusIndex.set(0)"
                (keydown.space)="modelFocusIndex.set(0)"
              >
                ...
                <div class="ml-stack-list">
                  <div class="ml-stack-item">
                    <span class="ml-lib">Theater state</span
                    ><span class="ml-lic apache">shared</span>
                  </div>
                  <div class="ml-stack-item">
                    <span class="ml-lib">Policy</span
                    ><span class="ml-lic mit">same model</span>
                  </div>
                  <div class="ml-stack-item">
                    <span class="ml-lib">Readiness</span
                    ><span class="ml-lic mit">same model</span>
                  </div>
                  <div class="ml-stack-item">
                    <span class="ml-lib">Logistics</span
                    ><span class="ml-lic apache">same model</span>
                  </div>
                  <div class="ml-stack-item">
                    <span class="ml-lib">Labs</span
                    ><span class="ml-lic mit">same model</span>
                  </div>
                </div>
                <div class="ml-card-note">
                  5 domäner, 4 typer av dataflöden och 1 gemensam semantik
                  driver samma beslutsyta.
                </div>
                <p class="ml-card-note">
                  Det som skiljer Steel från en UI-demo är att samma state
                  driver flera ytor samtidigt.
                </p>
              </div>
              ...
              <div
                class="ml-card"
                [class.ml-card-focus]="modelFocusIndex() === 1"
                (click)="modelFocusIndex.set(1)"
                tabindex="0"
                (keydown.enter)="modelFocusIndex.set(1)"
                (keydown.space)="modelFocusIndex.set(1)"
              >
                <div class="ml-card-header">
                  <span class="ml-icon">⊛</span>
                ...
                <div class="ml-flag-row">
                  ...
                  <div class="ml-flag-item">
                    ...
                    <div class="ml-flag-text">
                      ...
                      <div class="ml-flag-sub">
                        Policy, readiness, logistics, labs
                      </div>
                    </div>
                  </div>
                  <div class="ml-flag-item">
                ...
                <div class="ml-card-note">
                  3 lager, 2 lagringsled och 1 gemensamt kontrakt håller
                  betydelsen stabil.
                </div>
                <p class="ml-card-note">
                  Semantiken flyttas inte runt som kopior. Den läses från samma
                  källa av varje yta.
                </p>
              </div>
              ...
              <!-- Consumers -->
              <div
                class="ml-card ml-card-highlight"
                [class.ml-card-focus]="modelFocusIndex() === 2"
                (click)="modelFocusIndex.set(2)"
                tabindex="0"
                (keydown.enter)="modelFocusIndex.set(2)"
                (keydown.space)="modelFocusIndex.set(2)"
              >
                <div class="ml-card-header">
                  <span class="ml-icon">⊟</span>
                ...
                <div class="ncs-specs">
                  <div class="ncs-spec">
                    <span class="ncs-k">Policy</span
                    ><span class="ncs-v">same state</span>
                  </div>
                  <div class="ncs-spec">
                    <span class="ncs-k">Readiness</span
                    ><span class="ncs-v">same state</span>
                  </div>
                  <div class="ncs-spec">
                    <span class="ncs-k">Logistics</span
                    ><span class="ncs-v">same state</span>
                  </div>
                  <div class="ncs-spec">
                    <span class="ncs-k">Governance</span
                    ><span class="ncs-v">same state</span>
                  </div>
                  <div class="ncs-spec">
                    <span class="ncs-k">Labs</span
                    ><span class="ncs-v">same state</span>
                  </div>
                </div>
                <div class="ncs-badge">5 ytor · 1 semantic contract</div>
                <div class="ncs-badge">
                  State re-used across all major surfaces
                </div>
              </div>
              ...
              <div
                class="ml-card"
                [class.ml-card-focus]="modelFocusIndex() === 3"
                (click)="modelFocusIndex.set(3)"
                tabindex="0"
                (keydown.enter)="modelFocusIndex.set(3)"
                (keydown.space)="modelFocusIndex.set(3)"
              >
                <div class="ml-card-header">
                  <span class="ml-icon">◷</span>
                ...
                <div class="system-compare">
                  <div class="system-compare-summary">
                    Dagens system sprider läget över flera ytor. BDT samlar
                    samma theatre state, samma beslutskedja och samma semantik i
                    en modell.
                  </div>
                  ...
                  @for (row of systemComparison; track row.label) {
                    <div class="system-compare-row">
                      <div class="system-compare-legacy">
                        <div class="system-pill system-pill-legacy">
                          Fragmenterat
                        </div>
                        <div class="system-compare-text">
                          {{ row.legacyText }}
                        </div>
                      </div>
                      <div class="system-compare-center">
                        ...
                        <div class="system-compare-benefit">
                          {{ row.benefit }}
                        </div>
                      </div>
                ...
                <div class="system-compare-note">
                  BDT vinner eftersom samma state, samma semantik och samma
                  kontrakt används i alla ytor. Det ger mindre drift, snabbare
                  beslut och mindre risk för att demo, governance och
                  operationer säger olika saker.
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="slide-left-panel">
                ...
                <div class="data-strip data-strip-tight">
                  <div class="data-pill">
                    ...
                    ><span class="data-pill-label">Domäner</span
                    ><span class="data-pill-text"
                      >ett språk för hela systemet</span
                    >
                  </div>
                  <div class="data-pill">
                    <span class="data-pill-num">14</span
                    ><span class="data-pill-label">Inputs</span
                    ><span class="data-pill-text"
                      >policy, tracks, logistics, UI, infra</span
                    >
                  </div>
                  <div class="data-pill">
                    <span class="data-pill-num">1</span
                    ><span class="data-pill-label">Ontology</span
                    ><span class="data-pill-text">en modell, många vyer</span>
                  </div>
                  <div class="data-pill">
                    <span class="data-pill-num">0</span
                    ><span class="data-pill-label">Dubbeltydlighet</span
                    ><span class="data-pill-text"
                      >samma betydelse överallt</span
                    >
                  </div>
                </div>
                ...
                <div class="gov-authority-levels">
                  @for (
                    domain of ontologyDomains;
                    track domain.id;
                    let i = $index
                  ) {
                    <div
                      class="auth-level"
                      [class.active-auth]="ontologyFocusIndex() === i"
                      (click)="ontologyFocusIndex.set(i)"
                      tabindex="0"
                      (keydown.enter)="ontologyFocusIndex.set(i)"
                      (keydown.space)="ontologyFocusIndex.set(i)"
                    >
              ...
              <div class="gov-right">
                ...
                <div class="gov-factors">
                  @for (
                    ...
                    <div
                      class="gov-factor"
                      [class.gov-factor-active]="ontologyFocusIndex() === i"
                    >
                      <div class="gf-top">
              ...
              <div class="slide-left-panel">
                ...
                <div class="kg-section">
                  ...
                  <div class="kg-section-items">
                    @for (
                      effect of unificationEffects;
                      track effect.id;
                      let i = $index
                    ) {
                      <div
                        class="kg-item"
                        [class.kg-item-active]="unificationFocusIndex() === i"
                        (click)="unificationFocusIndex.set(i)"
                        tabindex="0"
                        (keydown.enter)="unificationFocusIndex.set(i)"
                        (keydown.space)="unificationFocusIndex.set(i)"
                      >
                        <strong>{{ effect.title }}</strong> · {{ effect.body }}
                      </div>
                    }
                  </div>
                </div>
                ...
                <div class="kg-section">
                  ...
                  <div class="kg-section-items">
                    <div class="kg-item">
                      01 Theater state · samma ingång för alla beslut
                    </div>
                    <div class="kg-item">
                      02 COA solver · policy weights och reserve floor
                    </div>
                    <div class="kg-item">
                      03 Counterfactual lab · decision tree och ML inferens
                    </div>
                    <div class="kg-item">
                      04 Governance & audit · samma beslutskedja
                    </div>
                    <div class="kg-item">
                      05 Field console · operatören ser samma semantik
                    </div>
                  </div>
                </div>
                ...
                <div class="kg-section">
                  ...
                  <div class="kg-section-items">
                    <div class="kg-item">
                      C2 resilience · command friction och collapse horizon
                    </div>
                    <div class="kg-item">
                      Threat inspector · intent och osäkerhet i samma
                      domänmodell
                    </div>
                    <div class="kg-item">
                      Demo director · scenario injection med samma kontrakt
                    </div>
                    <div class="kg-item">
                      Sovereign deployment · lokal eller EU utan semantisk drift
                    </div>
                  </div>
                </div>
                ...
                <div class="kg-section">
                  ...
                  <div class="kg-path-rail">
                    @for (node of kgPathNodes; track node.id; let i = $index) {
                      <button
                        class="kg-path-node"
                        [class.kg-path-node-active]="kgNodeIndex() === i"
                        (click)="selectKgNode(i)"
                      >
                        <span class="kg-path-node-index">0{{ i + 1 }}</span>
                        <span class="kg-path-node-title">{{ node.title }}</span>
                        <span class="kg-path-node-summary">{{
                          node.summary
                        }}</span>
                      </button>
                  ...
                  @if (currentKgNode(); as kgNode) {
                    <div class="kg-info-card">
                      <div class="kg-info-top">
                        ...
                        <div class="kg-info-step">
                          {{ kgNodeIndex() + 1 }} / {{ kgPathNodes.length }}
                        </div>
                      </div>
                      <div class="kg-info-body">{{ kgNode.detail }}</div>
                      <div class="kg-info-unlocks">
                        Varför detta spelar roll: {{ kgNode.unlocks }}
                      </div>
                    </div>
                  }
                </div>
                ...
                <p class="kg-hint">
                  Samma state och samma ontologi gör att dessa ytor kan växa
                  ihop utan att bli feature-islands.
                </p>
              </div>
          ...
          <div class="slide slide-summary animate-in">
            ...
            <div class="summary-grid">
              <div class="sum-card">
                ...
                <div class="sum-label">
                  1 operatörsmål, 3 roller och 1 tydlig beslutspunkt
                </div>
              </div>
              <div class="sum-card">
                <div class="sum-num green">Påverkan</div>
                <div class="sum-label">
                  2 risker: fel prioritering nu eller förlorad uthållighet sen
                </div>
              </div>
              <div class="sum-card">
                <div class="sum-num purple">Oundvikliga aktiviteter</div>
                <div class="sum-label">
                  5 steg: samla, fusionera, välja, validera, skydda
                </div>
              </div>
              <div class="sum-card">
                <div class="sum-num amber">Lösningsstruktur</div>
                <div class="sum-label">
                  3 metoder, 5 domäner och 1 delad state
                </div>
              </div>
            </div>
            ...
            <div class="data-strip data-strip-tight">
              <div class="data-pill">
                <span class="data-pill-num">3</span
                ><span class="data-pill-label">Novel metoder</span
                ><span class="data-pill-text">COA, validation, ontology</span>
              </div>
              <div class="data-pill">
                <span class="data-pill-num">5</span
                ><span class="data-pill-label">Domäner</span
                ><span class="data-pill-text"
                  >beslut, läge, logistik, yta, infra</span
                >
              </div>
              <div class="data-pill">
                <span class="data-pill-num">7</span
                ><span class="data-pill-label">Surfaces</span
                ><span class="data-pill-text"
                  >allt från field console till knowledge graph</span
                >
              </div>
              <div class="data-pill">
                <span class="data-pill-num">1</span
                ><span class="data-pill-label">State</span
                ><span class="data-pill-text">en källa, en semantik</span>
              </div>
            </div>
            ...
            <div class="summary-pillars">
              @for (method of novelMethods; track method.id; let i = $index) {
                <div
                  class="pillar"
                  [class.pillar-active]="summaryFocusIndex() === i"
                  (click)="summaryFocusIndex.set(i)"
                  tabindex="0"
                  (keydown.enter)="summaryFocusIndex.set(i)"
                  (keydown.space)="summaryFocusIndex.set(i)"
                >
            ...
            <div class="summary-answer">
              Hackathonet bad inte om ett helt system. Steel visar den del som
              måste vara rätt först: en ontologi som binder ihop data, beräknar
              causal intent, ger konkreta förslag, sänker kognitiv belastning i
              C2 och går att utvärdera mot faktisk sensordata nära realtid för
              att förbättra inferenskedjan efter att händelser utspelat sig.
            </div>

            <div class="summary-cta">
              <a routerLink="/" class="cta-btn"
                >Öppna systemet <span class="cta-arrow">→</span></a
              >
        ...
        @if (!slideDemoStarted()[currentSlide()]) {
          <button
            class="demo-overlay"
            type="button"
            (click)="startCurrentSlideDemo($event)"
          >
            <span class="demo-overlay-kicker"
              >Klicka en gång för att starta demo</span
            >
            <span class="demo-overlay-lead">{{
              slidePreviewCopy[currentSlide()].lead
            }}</span>
            <span class="demo-overlay-title">{{
              slides[currentSlide()].title
            }}</span>
            <span class="demo-overlay-sub">{{
              slidePreviewCopy[currentSlide()].detail
            }}</span>
            <div class="demo-overlay-bullets">
              @for (
                bullet of slidePreviewCopy[currentSlide()].bullets;
                track bullet
              ) {
      ...
      <div class="console-window">
        ...
        <div class="console-body">
          ...
          @for (line of visibleConsoleLines(); track $index) {
            <div
              class="console-line"
              [class.console-dim]="$index < visibleConsoleLines().length - 4"
            >
              <span class="console-prompt">$</span>
              <span>{{ line }}</span>
            </div>
    ...
    `
      ...
      .showcase-bg {
        ...
        background:
          radial-gradient(
            circle at 20% 20%,
            rgba(92, 167, 255, 0.12),
            transparent 30%
          ),
          radial-gradient(
            circle at 80% 80%,
            rgba(124, 224, 190, 0.08),
            transparent 30%
          ),
          radial-gradient(
            circle at 60% 40%,
      ...
      .w-chip-dot.purple {
        ...
        box-shadow: 0 0 8px var(--s-purple);
      }
      .w-chip-dot.amber {
        background: var(--s-amber);
        box-shadow: 0 0 8px var(--s-amber);
      }
      .welcome-stack {
        display: flex;
        flex-direction: column;
      ...
      .recommendation-card-active {
        border-color: rgba(124, 224, 190, 0.32);
        background: rgba(124, 224, 190, 0.06);
      }
      ...
      .s-tab.active .s-tab-num {
        background: rgba(92, 167, 255, 0.3);
      }
      .map-legend {
        display: flex;
        flex-direction: column;
      ...
      .legend-dot.white {
        background: rgba(156, 176, 199, 0.5);
        border: 1px solid rgba(156, 176, 199, 0.4);
      }
      .map-stats {
        display: flex;
        gap: 12px;
      ...
      .intercept-core {
        animation: interceptCoreFade 0.3s ease-out both;
      }
      ...
      .map-phase-label.phase-intercept {
        color: var(--s-green);
        animation: phaseFlash 0.6s ease-in-out infinite alternate;
      }
      ...
      .phase-bar-track {
        height: 2px;
        background: rgba(148, 189, 255, 0.1);
        border-radius: 1px;
        overflow: hidden;
      }
      .phase-bar-fill {
        height: 100%;
        background: linear-gradient(90deg, #5ca7ff, #7ce0be);
        border-radius: 1px;
        transition: width 0.06s linear;
      }
      .phase-bar-fill.phase-fill-intercept {
        background: linear-gradient(90deg, #7ce0be, #5ca7ff);
      }
      .stat-r {
        color: var(--s-red);
      }
      ...
      .validation-tree-card:hover {
        border-color: rgba(92, 167, 255, 0.28);
        background: rgba(92, 167, 255, 0.05);
      }
      .validation-tree-card-active {
        border-color: rgba(92, 167, 255, 0.35);
      ...
      .validation-tree-card-premise {
        font-size: 13px;
        line-height: 1.6;
        color: var(--s-text);
        margin-bottom: 8px;
      }
      .validation-tree-card-meta {
        font-size: 11px;
        color: var(--s-muted);
        text-transform: uppercase;
        letter-spacing: 0.12em;
      ...
      .board-demo-stage-head {
        display: flex;
        flex-direction: column;
        gap: 4px;
        padding: 0 2px;
      }
      .board-demo-stage-title {
        font-size: 12px;
        font-weight: 800;
        color: var(--s-text);
        line-height: 1.45;
      }
      .board-demo-stage-sub {
        font-size: 11px;
        color: var(--s-muted);
        line-height: 1.45;
      }
      ...
      .validation-inference-card:hover {
        border-color: rgba(92, 167, 255, 0.28);
        background: rgba(92, 167, 255, 0.05);
      }
      .validation-inference-card-active {
        border-color: rgba(124, 224, 190, 0.35);
        background: rgba(124, 224, 190, 0.07);
      }
      .validation-inference-top {
        display: flex;
        align-items: center;
        justify-content: space-between;
        gap: 8px;
      }
      .validation-inference-label {
        font-size: 11px;
        font-weight: 900;
        color: var(--s-blue);
        text-transform: uppercase;
      ...
      .validation-inference-score {
        font-size: 11px;
        font-weight: 900;
        font-family: monospace;
        color: var(--s-text);
      }
      .validation-inference-line {
        font-size: 11px;
        line-height: 1.55;
        color: var(--s-muted);
      }
      ...
      .board-feat .feat-icon {
        font-size: 17px;
        width: 22px;
      }
      .board-feat .feat-text {
        min-width: 0;
      }
      .board-feat .feat-sub {
      ...
      .ml-card-focus {
        border-color: rgba(92, 167, 255, 0.35);
        background: rgba(92, 167, 255, 0.06);
        box-shadow: 0 0 0 1px rgba(92, 167, 255, 0.08) inset;
      }
      .ml-card-primary {
      ...
      .ml-card-highlight {
        border-color: rgba(124, 224, 190, 0.25);
      ...
      .system-pill-bdt {
        color: #c9fff0;
        background: rgba(124, 224, 190, 0.12);
        border: 1px solid rgba(124, 224, 190, 0.18);
      }
      .system-compare-text {
        font-size: 11px;
        line-height: 1.55;
      ...
      .ml-flag.se {
        ...
        color: #66cc99;
        border: 1px solid rgba(0, 107, 56, 0.4);
      }
      .ml-flag-name {
        font-size: 12px;
        font-weight: 700;
      ...
      .gov-factor-active {
        border-color: rgba(92, 167, 255, 0.25);
        background: rgba(92, 167, 255, 0.05);
      }
      .gf-top {
        display: flex;
      ...
      .console-meta {
        ...
        letter-spacing: 0.18em;
        color: rgba(156, 176, 199, 0.78);
        border-bottom: 1px solid rgba(148, 189, 255, 0.1);
        margin-bottom: 6px;
      }
      .console-line {
        font-size: 13px;
        font-family: "JetBrains Mono", "Courier New", monospace;
        color: rgba(124, 224, 190, 0.95);
        display: flex;
        gap: 6px;
        line-height: 1.65;
      }
      ...
      .console-cursor {
        width: 7px;
        height: 12px;
        background: rgba(124, 224, 190, 0.8);
...
export class Showcase implements OnInit, OnDestroy {
  ...
  selectedScenarioTrack = computed(
    () =>
      this.animatedTracks().find(
        (track) => track.id === this.selectedScenarioTrackId(),
      ) ?? null,
  );
  currentScenarioStory = computed(
    () => this.scenarioStories[this.mapScenario()] ?? this.scenarioStories[0],
  );
  currentRecommendation = computed(
    () =>
      this.scenarioRecommendations[this.recommendationIndex()] ??
      this.scenarioRecommendations[0],
  );
  currentValidationTree = computed(
    () =>
      this.validationTrees[this.validationTreeIndex()] ??
      this.validationTrees[0],
  );
  activeValidationBranchIndex = computed(
    () =>
      this.validationFocusIndex() %
      Math.max(1, this.currentValidationTree().branches.length),
  );
  currentKgNode = computed(
    () => this.kgPathNodes[this.kgNodeIndex()] ?? this.kgPathNodes[0],
  );
  ...
  private _startTrackAnim(): void {
    ...
    this._demoTick = 0;
    let cueIndex = Math.max(
      0,
      DEMO_CUES.findIndex((cue) => cue.scenarioIndex === this.mapScenario()),
    );
  ...
  startCurrentSlideDemo(event?: MouseEvent): void {
    ...
    if (slide === 2) {
      this._slideDemoTimer = setInterval(() => {
        this.selectedCoaId.set(
          COA_CYCLE[this._slideDemoStep % COA_CYCLE.length],
        );
        this._slideDemoStep++;
      }, 1400);
      return;
    ...
    if (slide === 3) {
      this._slideDemoTimer = setInterval(() => {
        this.validationFocusIndex.set(
          this._slideDemoStep % this.validationSteps.length,
        );
        this.validationTreeIndex.set(
          this._slideDemoStep % this.validationTrees.length,
        );
        this._slideDemoStep++;
      }, 1500);
      return;
    ...
    if (slide === 5) {
      this._slideDemoTimer = setInterval(() => {
        this.ontologyFocusIndex.set(
          this._slideDemoStep % this.ontologyDomains.length,
        );
        this._slideDemoStep++;
      }, 1250);
      return;
    ...
    if (slide === 6) {
      this._slideDemoTimer = setInterval(() => {
        this.unificationFocusIndex.set(
          this._slideDemoStep % this.unificationEffects.length,
        );
    ...
    if (slide === 7) {
      this._slideDemoTimer = setInterval(() => {
        this.summaryFocusIndex.set(
          this._slideDemoStep % this.novelMethods.length,
        );
        this._slideDemoStep++;
      }, 1500);
    }
  ...
  selectScenario(idx: number): void {
    ...
    this.recommendationIndex.set(
      Math.min(idx, this.scenarioRecommendations.length - 1),
    );
  ...
  onTrackScrub(e: Event): void {
    ...
    this._demoTick = Math.round(
      (value / 100) * (this._flyTicks + this._interceptTicks),
    );
  }
  ...
  trackSummary(track: AnimatedTrack): string {
    if (this.mapScenario() === 2) {
      if (track.id === "S1")
        return "Supply line som måste hålla öppet för att support ska nå fram i tid.";
      if (track.id === "S2")
        return "Eskort och skydd för korridoren, där reserve floor vägs mot räckvidd.";
      if (track.id === "S3")
        return "Hotet som gör att ett beslut måste tas innan korridoren bryts.";
      if (
        track.id === "S4" ||
        track.id === "S5" ||
        track.id === "S6" ||
        ...
        return "Drönare i svärm som pressar korridoren och påverkar beslutet direkt.";
  ...
  trackFacts(track: AnimatedTrack): TrackFact[] {
    const secondsLeft = Math.max(
      6,
      Math.round((1 - this.trackProgress()) * 52),
    );
    ...
    if (scenario === 2) {
      ...
      return [
        ...
        },
        {
          ...
          value:
            track.id === "S1"
              ? "Support reaches base"
              : track.id === "S3"
                ? "Corridor breaks"
                : isSwarm
                  ? "Corridor pressure rises"
                  : "Reserve is consumed",
        },
      ];
    }
    if (scenario === 1) {
      return [
        {
          label: "Roll",
          value: track.type === "missile" ? "Inbound threat" : "Support track",
        },
        { label: "Tid", value: `${secondsLeft}s` },
        {
          label: "Beslut",
          value: this.intercepting() ? "Intercept" : "Track and wait",
        },
    ...
    return [
      {
        label: "Roll",
        value: track.type === "ship" ? "Surface track" : "Air track",
      },
      { label: "Tid", value: `${secondsLeft}s` },
      {
        label: "Beslut",
        value: this.intercepting() ? "Commit interceptors" : "Hold reserve",
      },
      {
        label: "Risk",
        value: track.type === "air" ? "Fast-changing" : "Persistent",
      },
    ];
  }
  ...
  trackDecisionSupport(track: AnimatedTrack): TrackDecisionSupport[] {
    ...
    if (scenario === 2) {
      ...
      return [
        {
          label: "Data",
          value: "4 logistics signals",
          detail: "Last, corridor pressure, escort and runway status.",
        },
        {
          ...
          value:
            track.id === "S3"
              ...
              : isSwarm
                ? "Suppress swarm"
                : "Protect corridor",
          detail: "Tidigt beslut behövs innan linjen bryts.",
        },
        {
          label: "Why now",
          value: `${secondsLeft}s decision window`,
          detail: `${corridor} påverkar samma state som COA och validation.`,
        },
      ];
    }
    if (scenario === 1) {
      return [
        {
          label: "Data",
          value: track.type === "missile" ? "3 inbound cues" : "2 support cues",
          detail: "Speed, bearing and approach shape the picture.",
        },
        {
          label: "Recommendation",
          value: this.intercepting() ? "Commit intercept" : "Track and wait",
          detail: "Valet skiftar när hotet går in i fönstret.",
        },
        {
          label: "Why now",
          value: `${secondsLeft}s decision window`,
          detail: "Antagandet måste låsas före salvo splittrar sig.",
        },
      ];
    }
    return [
      {
        label: "Data",
        value: track.type === "ship" ? "2 surface cues" : "2 air cues",
        detail: "Track speed, route and intent signal the branch.",
      },
      {
        label: "Recommendation",
        value: this.intercepting() ? "Commit interceptors" : "Hold reserve",
        detail: "Rekommendationen bevarar nästa våg.",
      },
      {
        label: "Why now",
        value: `${secondsLeft}s decision window`,
        detail: "Objektet visar var beslutet måste tas först.",
      },
    ];
  }
  ...
  coaX(readiness: number): number {
    return 40 + (readiness / 100) * 260;
  }
  // Convert intercept (0-100) → SVG y coordinate [190..10]
  coaY(intercept: number): number {
    return 190 - (intercept / 100) * 180;
  }
}
